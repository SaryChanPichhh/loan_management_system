                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_code"
                                               ...
                                               value="{{ old('product_code', $loanProduct->product_code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="3"
                                          ...
                                          placeholder="ព័ត៌មានលម្អិតអំពីផលិតផលកម្ចីនេះ...">{{ old('description', $loanProduct->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="max_term_months" min="1" max="360"
                                                   ...
                                                   value="{{ old('max_term_months', $loanProduct->max_term_months) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="late_fee_rate" step="0.0001" min="0"
                                                   ...
                                                   value="{{ old('late_fee_rate', $loanProduct->late_fee_rate) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="penalty_rate" step="0.0001" min="0"
                                                   ...
                                                   value="{{ old('penalty_rate', $loanProduct->penalty_rate) }}">
                                            <div class="input-group-append"><span class="input-group-text">%</span></div>
                                            @error('penalty_rate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row">
                                    @foreach([
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="radio-card {{ old('interest_type', $loanProduct->interest_type) === $value ? 'border-primary bg-light' : '' }}">
                                                <label class="d-flex align-items-start cursor-pointer w-100 mb-0" style="cursor:pointer;">
                                                    <input type="radio" name="interest_type" value="{{ $value }}"
                                                           class="mt-1 mr-2" {{ old('interest_type', $loanProduct->interest_type) === $value ? 'checked' : '' }}>
                                                    <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="guarantor_income_multiplier" step="0.1" min="0"
                                           ...
                                           value="{{ old('guarantor_income_multiplier', $loanProduct->guarantor_income_multiplier) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="requires_collateral_above" step="0.01" min="0"
                                           ...
                                           value="{{ old('requires_collateral_above', $loanProduct->requires_collateral_above) }}">
                        ...
                        <div class="card-body">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="statusSwitch"
                                       name="status" {{ old('status', $loanProduct->status) ? 'checked' : '' }}>
