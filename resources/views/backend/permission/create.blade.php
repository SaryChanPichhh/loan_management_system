                            ...
                            <form action="{{ route('permission.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="ឧ. បង្កើតអតិថិជន">
                                        @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="slug">Slug (Route Name) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug') }}" required placeholder="ឧ. customer.create">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('module') is-invalid @enderror" id="module" name="module" value="{{ old('module') }}" required placeholder="ឧ. Customer Management">
                                ...
                                <div class="text-right">
                                    ...
                                    <button type="submit" class="btn btn-success"><i data-feather="save"></i> រក្សាទុក</button>
                                </div>
                            </form>
                        </div>
                    </div>
