        ...
        <div class="col-12 col-md-8 mx-auto">
            <div class="card shadow-sm border-0 mb-4 p-4" style="background: linear-gradient(135deg, #1e2433 0%, #1a1f2c 100%); border-radius: 12px;">
                <div class="d-flex align-items-center justify-content-between mb-0">
                    <h5 class="text-white mb-0">
                        <i class="fas fa-hand-holding-usd text-warning mr-2"></i> Disbursement
                    </h5>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body p-4">
                    <h6 class="mb-4"><i class="fas fa-money-check-alt text-success mr-2"></i> Disbursement Details</h6>
                    ...
                    <form action="{{ route('loans.disburse', $loan->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-warning px-4" style="font-weight: 600;">
